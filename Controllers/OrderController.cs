...
namespace Evention2.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        private int GenerateOrder([Bind(Include = "Order_Id,User_Id,Pay_Method,Total_Price")] Order order)
        {
        ...
        private bool InsertSkuOrder(int orderId, List<TicketOrder> tickets)
        {
            return false;
        }
